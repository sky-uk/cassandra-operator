...
import (
	...
	"github.com/sky-uk/cassandra-operator/cassandra-operator/pkg/client/clientset/versioned/scheme"
...
// CoreV1alpha1Client is used to interact with features provided by the core.sky.uk group.
type CoreV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CoreV1alpha1Client) Cassandras(namespace string) CassandraInterface {
